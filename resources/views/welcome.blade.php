...
@section('title', 'Cota Brasilis - Transforme suas Cotas em Oportunidades')
...
<section class="hero-section position-relative">
    <div class="container position-relative hero-inner py-4 py-lg-5">
        <div class="hero-intro text-white" data-aos="fade-up" data-aos-duration="900">
            <div class="hero-badge badge rounded-pill">
                <i class="fas fa-star me-2"></i>Plataforma #1 em Cotas Hoteleiras
            </div>
            <h1 class="hero-title display-3 fw-bold mb-3 mb-md-4 lh-sm">
                <span class="hero-title-accent">Transforme suas frustrações</span><br>
                <span class="hero-title-green">em oportunidades turísticas deslumbrantes</span>
            </h1>
            <p class="hero-lead lead mb-4 mb-md-5">
                Desconstruída a hospedagem tradicional, organizamos sabiamente o uso de Cotas e Frações de Multipropriedade Hoteleira para que todos possam viver o autêntico e extraordinário BRASIL, garantidos seus direitos de uso, aluguel, troca, compra e venda com a intenção de oportunizar a realização de seus sonhos turísticos a partir de hospedagens deslumbrantes com facilidade, segurança e preços justos.
            </p>
            <div class="hero-taglines text-center mx-auto">
                <p class="hero-tagline mb-2">
                    <span class="hero-highlight">Cota Brasilis</span>, pioneiro e profissional com Cotas de Multipropriedade Hoteleira.
                </p>
                <p class="hero-tagline mb-0">
                    Zelo pelo Sagrado <span class="hero-highlight">BRASIL</span>, cuidado e afeto com Você, a Natureza e o Turismo.
                </p>
            </div>
        </div>

        <div class="row hero-split align-items-center g-4 mt-2 mt-lg-4">
            <div class="col-12 col-lg-4 col-xl-4 hero-col-stats" data-aos="fade-right" data-aos-duration="1000" data-aos-delay="100">
                <div class="trust-indicators">
                    <div class="row g-3">
                        <div class="col-6">
                            <div class="hero-stat-card">
                                <div class="hero-stat-icon hero-stat-icon--green"><i class="fas fa-building"></i></div>
                                <div class="hero-stat-body">
                                    <div class="hero-stat-value">{{ number_format($heroStats['rented'] ?? 0, 0, ',', '.') }}</div>
                                    <small class="hero-stat-label">Cotas Alugadas</small>
                                </div>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="hero-stat-card">
                                <div class="hero-stat-icon hero-stat-icon--cyan"><i class="fas fa-exchange-alt"></i></div>
                                <div class="hero-stat-body">
                                    <div class="hero-stat-value">{{ number_format($heroStats['exchanged'] ?? 0, 0, ',', '.') }}</div>
                                    <small class="hero-stat-label">Cotas Trocadas</small>
                                </div>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="hero-stat-card">
                                <div class="hero-stat-icon hero-stat-icon--yellow"><i class="fas fa-shopping-cart"></i></div>
                                <div class="hero-stat-body">
                                    <div class="hero-stat-value">+{{ number_format($heroStats['purchased'] ?? 0, 0, ',', '.') }}</div>
                                    <small class="hero-stat-label">Cotas compradas</small>
                                </div>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="hero-stat-card">
                                <div class="hero-stat-icon hero-stat-icon--yellow"><i class="fas fa-handshake"></i></div>
                                <div class="hero-stat-body">
                                    <div class="hero-stat-value">+{{ number_format($heroStats['sold'] ?? 0, 0, ',', '.') }}</div>
                                    <small class="hero-stat-label">Cotas vendidas</small>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="hero-actions mt-4">
                    <a href="{{ route('register') }}" class="btn hero-cta-btn btn-lg">
                        <i class="fas fa-rocket me-2"></i>Começar Gratuitamente
                    </a>
                </div>
            </div>
            <div class="col-12 col-lg-8 col-xl-8 hero-col-map" data-aos="fade-left" data-aos-duration="1000" data-aos-delay="200">
                <div class="hero-map-frame map-wrapper">
                <div class="hero-map-inner">
                    <svg id="map" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 800 600" preserveAspectRatio="xMidYMid meet">
                    <defs>
                        <style>
                            .shape {
                                fill: #e0e0e0;
                            ...
                            /* Estados sem cotas mantêm cor da região mas com opacidade reduzida */
                            #shape_ac.no-quotas,
                            #shape_am.no-quotas,
                            #shape_ap.no-quotas,
                            #shape_pa.no-quotas,
                    ...
                    <g class="model-green">
                        ...
                        <a id="state_pe" class="state" xlink:href="">
                            <desc id="description_pe" style="color: white;">Pernambuco</desc>
                        ...
                        <a id="state_al" class="state" xlink:href="">
                            <desc id="description_al" style="color: white;">Alagoas</desc>
    ...
    <div class="container">
        <div class="row">
            <div class="col-12 text-center mb-5" data-aos="fade-up">
                <h2 class="display-5 fw-bold mb-3">Cotas em Destaque</h2>
               
            </div>
        </div>
        <div class="row g-4">
            @if(isset($highlightCards) && count($highlightCards) > 0)
            @foreach($highlightCards as $index => $item)
            <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="{{ ($index + 1) * 100 }}">
                @if($item['has_data'] && isset($item['hotel']) && $item['hotel'] && isset($item['hotel']->images) && is_array($item['hotel']->images) && count($item['hotel']->images) > 0)
                <a href="{{ route('public.quotas.show', $item['quota']) }}"
                    class="destination-card text-decoration-none"
                    style="display: block;">
                    <div class="destination-image">
                        <div id="carousel-featured-{{ $index }}" class="carousel slide h-100" data-bs-ride="carousel" data-bs-interval="3000">
                            <div class="carousel-inner h-100">
                                @foreach($item['hotel']->images as $imgIndex => $image)
                            ...
                            @if(count($item['hotel']->images) > 1)
                            <button class="carousel-control-prev" type="button" data-bs-target="#carousel-featured-{{ $index }}" data-bs-slide="prev" onclick="event.preventDefault(); event.stopPropagation();">
                                <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                                <span class="visually-hidden">Previous</span>
                            </button>
                            <button class="carousel-control-next" type="button" data-bs-target="#carousel-featured-{{ $index }}" data-bs-slide="next" onclick="event.preventDefault(); event.stopPropagation();">
                        ...
                        <div class="destination-overlay">
                            <div class="destination-info">
                                <h5 class="fw-bold text-white">{{ $item['hotel']->name }}</h5>
                                <p class="text-white-50 mb-0">{{ $item['quota']->location ?? $item['hotel']->location }}</p>
                                <div class="destination-meta">
                                    @if($item['quota']->rental_price)
                                    <span class="highlight-price">R$ {{ number_format($item['quota']->rental_price, 2, ',', '.') }}</span>
                                    @else
                                    <span class="highlight-price text-white">Sob consulta</span>
                                    @endif
                                </div>
                            </div>
                            <span class="highlight-badge {{ $item['badge_class'] }}">{{ $item['title'] }}</span>
                        </div>
                    </div>
                </a>
                @else
                <div class="destination-card text-decoration-none" style="min-height: 250px;">
                    <div class="d-flex align-items-center justify-content-center h-100 p-4 text-center position-relative">
                        <div>
                            <h5 class="fw-bold mb-2">{{ $item['title'] }}</h5>
                            <p class="text-muted mb-0">Nenhuma cota disponível nesta categoria no momento.</p>
                        </div>
                        <span class="highlight-badge {{ $item['badge_class'] }}">{{ $item['title'] }}</span>
                    </div>
                </div>
            ...
            <div class="col-12 text-center" data-aos="fade-up">
                <p class="text-muted">Ainda não há cotas em destaque cadastradas.</p>
            </div>
            @endif
        </div>
    </div>
...
<!-- Additional Quotas Sections -->
<section class="py-5 bg-light">
    <div class="container">
        <!-- Cotas Novas -->
        <div class="row mb-5">
            <div class="col-12 mb-4">
                <h3 class="fw-bold mb-3 text-center">Para quem quer turbinar sua divulgação</h3>

            </div>
            <div class="col-12">
                <h4 class="fw-bold mb-1">07 Dias</h4>
                <div class="card shadow-sm border-0" style="height: 400px; overflow: hidden;">
                    <div id="carousel-new" class="carousel slide h-100" data-bs-ride="carousel" data-bs-interval="4000">
                        <div class="carousel-inner h-100">
                            @php
                            $newIndex = 0;
                            $newValidCount = 0;
                            @endphp
                            @if(isset($newQuotas) && count($newQuotas) > 0)
                            @foreach($newQuotas as $quota)
                            @php
                            $hotel = $hotels->get($quota->hotel_name) ?? null;
                            @endphp
                            @if($hotel && $hotel->images && count($hotel->images) > 0)
                                    @php
                                        $firstImage = is_array($hotel->images) ? ($hotel->images[0] ?? null) : null;
                                        $imagePath = $firstImage ? (str_starts_with($firstImage, 'storage/') ? $firstImage : 'storage/' . ltrim($firstImage, '/')) : null;
                                    @endphp
                                    @if($imagePath)
                            <div class="carousel-item h-100 {{ $newIndex === 0 ? 'active' : '' }}">
                                @php
                                $newIndex++;
                                $newValidCount++;
                                @endphp
                                <div class="row h-100 g-0">
                                    <div class="col-md-6 h-100">
                                            ...
                                            alt="{{ $hotel->name }}"
                                                    ...
                                                    <div class="bg-light d-flex align-items-center justify-content-center w-100 h-100" style="display: none;">
                                    ...
                                    <div class="col-md-6 d-flex align-items-center p-4">
                                        <div>
                                            ...
                                            <p class="text-muted mb-2"><i class="fas fa-map-marker-alt me-2"></i>{{ $quota->location }}</p>
                                            @foreach($quota->getPeriodDisplayLines() as $periodLine)
                                            <p class="mb-2"><i class="fas fa-calendar me-2"></i><strong>{{ $periodLine['label'] }}</strong> {{ $periodLine['formatted'] }}</p>
                                            @endforeach
                                            @if($quota->getPeriodDisplayLines() === [])
                                            <p class="mb-2"><i class="fas fa-calendar me-2"></i>{{ $quota->start_date ? \Carbon\Carbon::parse($quota->start_date)->format('d/m/Y') : '-' }} - {{ $quota->end_date ? \Carbon\Carbon::parse($quota->end_date)->format('d/m/Y') : '-' }}</p>
                                            @endif
                                            <p class="mb-2"><i class="fas fa-users me-2"></i>{{ $quota->number_of_guests }} hóspedes</p>
                                            @if($quota->rental_price)
                                            <p class="fw-bold text-success fs-4 mb-3">R$ {{ number_format($quota->rental_price, 2, ',', '.') }}</p>
                                            @endif
                                            <a href="{{ route('public.quotas.show', $quota) }}" class="btn btn-primary">Ver Detalhes</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="carousel-item active h-100 d-flex align-items-center justify-content-center">
                                <p class="text-muted">Nenhuma cota nova disponível no momento.</p>
                            </div>
                            @endif
                        </div>
                        @if(isset($newValidCount) && $newValidCount > 1)
            ...
            <div class="col-12">
                <h4 class="fw-bold mb-1 mt-4">14 Dias</h4>
                <div class="card shadow-sm border-0" style="height: 400px; overflow: hidden;">
                    <div id="carousel-recent" class="carousel slide h-100" data-bs-ride="carousel" data-bs-interval="4000">
                        <div class="carousel-inner h-100">
                            @php
                            $recentIndex = 0;
                            $recentValidCount = 0;
                            @endphp
                            @if(isset($recentQuotas) && count($recentQuotas) > 0)
                            @foreach($recentQuotas as $quota)
                            @php
                            $hotel = $hotels->get($quota->hotel_name) ?? null;
                            @endphp
                            @if($hotel && $hotel->images && count($hotel->images) > 0)
                            ...
                            @endphp
                            @if($imagePath)
                            <div class="carousel-item h-100 {{ $recentIndex === 0 ? 'active' : '' }}">
                                @php
                                $recentIndex++;
                                $recentValidCount++;
                                @endphp
                            ...
                            <div class="carousel-item active h-100 d-flex align-items-center justify-content-center">
                                <p class="text-muted">Nenhuma cota recente disponível no momento.</p>
                            </div>
                            @endif
                        </div>
                        @if(isset($recentValidCount) && $recentValidCount > 1)
                        <button class="carousel-control-prev" type="button" data-bs-target="#carousel-recent" data-bs-slide="prev">
                            <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                            <span class="visually-hidden">Previous</span>
                        </button>
                        <button class="carousel-control-next" type="button" data-bs-target="#carousel-recent" data-bs-slide="next">
                            <span class="carousel-control-next-icon" aria-hidden="true"></span>
                            <span class="visually-hidden">Next</span>
                        </button>
                        @endif
            ...
            <div class="col-12">
                <h4 class="fw-bold mb-1 mt-4">30 Dias</h4>
                <div class="card shadow-sm border-0" style="height: 400px; overflow: hidden;">
                    <div id="carousel-more" class="carousel slide h-100" data-bs-ride="carousel" data-bs-interval="4000">
                        <div class="carousel-inner h-100">
                            @php
                            $moreIndex = 0;
                            $moreValidCount = 0;
                            @endphp
                            @if(isset($moreQuotas) && count($moreQuotas) > 0)
                            @foreach($moreQuotas as $quota)
                            @php
                            $hotel = $hotels->get($quota->hotel_name) ?? null;
                            @endphp
                            @if($hotel && $hotel->images && count($hotel->images) > 0)
                            ...
                            @endphp
                            @if($imagePath)
                            <div class="carousel-item h-100 {{ $moreIndex === 0 ? 'active' : '' }}">
                                @php
                                $moreIndex++;
                                $moreValidCount++;
                                @endphp
                            ...
                            @if($moreValidCount === 0)
                            <div class="carousel-item active h-100 d-flex align-items-center justify-content-center">
                                <p class="text-muted">Nenhuma cota adicional disponível no momento.</p>
                            </div>
                            @endif
                        </div>
                        @if(isset($moreValidCount) && $moreValidCount > 1)
                        <button class="carousel-control-prev" type="button" data-bs-target="#carousel-more" data-bs-slide="prev">
                            <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                            <span class="visually-hidden">Previous</span>
                        </button>
                        <button class="carousel-control-next" type="button" data-bs-target="#carousel-more" data-bs-slide="next">
                            <span class="carousel-control-next-icon" aria-hidden="true"></span>
                            <span class="visually-hidden">Next</span>
                        </button>
                        @endif
...
<section class="cta-gradient-section py-5">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-10 text-center" data-aos="fade-up">
                <div class="cta-gradient-content">
                    <h2 class="display-4 fw-bold mb-4 text-white">
                        Venha sentir o privilégio de se hospedar e turistar pelo Brasil com facilidade, qualidade e segurança
                    </h2>
                    <div class="cta-gradient-buttons mt-4">
                        <a href="{{ route('register') }}" class="btn btn-warning btn-lg px-5 py-3 mb-3">
    ...
    <div class="container">
        <div class="row g-4">
            <div class="col-lg-6" data-aos="fade-up" data-aos-delay="300">
                <div class="info-card h-100" style="border: 5px solid #008834; border-radius: 20px;">
                    <div class="card border-0 shadow-sm h-100">
                        <div class="card-body p-4">
                            <div class="d-flex align-items-center mb-3">
                                ...
                                <h5 class="fw-bold mb-0">Cadastre-se e a sua cota, escolha o perfil adequado e abra um Brasil de Oportunidades</h5>
                            </div>
                            <p class="text-muted mb-0">
                                Usar sua cota agora é possível. E fácil. Graças ao nosso domínio da dinâmica da multipropriedade hoteleira,
                                comprometimento com o Turismo e você, aliado à simplicidade de nossa tecnologia e filtros de acordo com as suas necessidades.
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card border-0 shadow-sm h-100">
                        <div class="card-body p-4">
                            <div class="d-flex align-items-center mb-3">
                                ...
                                <h5 class="fw-bold mb-0">Diversidade de Opções</h5>
                            </div>
                            <p class="text-muted mb-0">
                                Hospedagens por todo Brasil em resorts, hotéis, pousadas com preço baixo e alta qualidade, tudo checado por nós.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-12" data-aos="fade-up" data-aos-delay="300">
                <div class="info-card h-100" style="border: 5px solid #ffc107; border-radius: 20px;">
                    <div class="card border-0 shadow-sm h-100">
                        <div class="card-body p-4">
                            <div class="d-flex align-items-center mb-3">
                                <div class="bg-warning bg-opacity-10 rounded-circle p-3 me-3">
                                ...
                                <h5 class="fw-bold mb-0">Sua liberdade, alegria e segurança para turistar. Nossa prioridade</h5>
                            </div>
                            <p class="text-muted mb-0">
                                O Cota Brasilis é dedicado a criar e promover uma comunidade confiável de experiências turísticas singulares com ênfase na hospedagem.
                                Leia o Termos de Uso, assista aos vídeos e <i>lives</i>, e considere nossas recomendações para melhor usar o aplicativo e cooperar com seu
                    ...
                    <div class="card border-0 shadow-sm h-100">
                        <div class="card-body p-4">
                            <div class="d-flex align-items-center mb-3">
                                ...
                                <h5 class="fw-bold mb-0">Confie em Quem é Profissional do Turismo</h5>
                            </div>
                            <p class="text-muted mb-0 text-start">
                                Para nós, é muito importante conhecer cada uma das hospedagens e parceiros. Conferimos estrutura física, serviços, certificações assim como os perfis, documentações e avaliações.
                                Assim, fortalecemos a confiança e a tranquilidade para você cada vez mais usar, divulgar, se engajar com o Cota Brasilis e desfrutar experiências turísticas autênticas, sustentáveis e com segurança em nossa plataforma.
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card border-0 shadow-sm h-100">
                        <div class="card-body p-4">
                            <div class="d-flex align-items-center mb-3">
                                ...
                                <h5 class="fw-bold mb-0">Economize Muito em Suas Viagens</h5>
                            </div>
                            <p class="text-muted mb-0">
                                Cadastre sua cota, economize e proporcione a quem não possui cota economizar, também,e ambos viajarem muito. É por cooperação e confiança que a Multipropriedade Hoteleira distribui seus múltiplos ganhos.
                            </p>
                        </div>
                    </div>
                </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-12 text-center mb-5" data-aos="fade-up">
                ...
                <p class="lead text-muted">Três passos simples para oferecer suas cotas, alugar, trocar, comprar ou vendê-las.</p>
            </div>
        </div>
        <div class="row g-4">
            <div class="col-lg-4" data-aos="fade-up" data-aos-delay="100">
                <div class="step-card text-center h-100">
                    ...
                    <h5 class="fw-bold mb-3">Cadastre Você e sua Cota</h5>
                    <p class="text-muted">Cadastre-se gratuitamente, escolha seu perfil e registre suas cotas hoteleiras com segurança. Ou apenas se cadastre e escolha seu perfil caso não possua Cota Hoteleira</p>
                </div>
            </div>
            <div class="col-lg-4" data-aos="fade-up" data-aos-delay="200">
                <div class="step-card text-center h-100">
                    ...
                    <h5 class="fw-bold mb-3">Busque ou Ofereça</h5>
                    <p class="text-muted">Quem cadastrou cota pode oferecê-las por inteiro ou fracionada para Aluguel e Troca, ou venda se quitada. Quem não tem cota pode alugar ou comprar de quem as tem. E, ainda, pode-se gerir as cotas de terceiros. Tudo num só lugar. E, exclusivamente, no Cota Brasilis.</p>
                </div>
            </div>
            <div class="col-lg-4" data-aos="fade-up" data-aos-delay="300">
                <div class="step-card text-center h-100">
                    ...
                    <h5 class="fw-bold mb-3">Encontre e Garanta</h5>
                    <p class="text-muted">Encontre a sua melhor opção, siga o procedimento da transação de olho no prazo, pague e receba autorização de sua hospedagem com total segurança.</p>
                </div>
            </div>
        </div>
    </div>
...
<section class="profile-types py-5 bg-light">
    <div class="container">
        <div class="row">
            <div class="col-12 text-center mb-5" data-aos="fade-up">
                <h2 class="display-5 fw-bold mb-3">Escolha Seu Perfil</h2>
                <p class="lead text-muted">Três perfis diferentes para otimizar suas viagens e oportunidades com cotas hoteleiras</p>
            </div>
        </div>
        <!-- Horizontal Profile Cards -->
        <div class="profile-cards-horizontal-container">
            <!-- Curioso Card -->
            <div class="profile-card-horizontal" data-aos="fade-up" data-aos-delay="100">
                <div class="profile-card-content">
                        ...
                        <div class="profile-features">
                            ...
                            <div class="feature-item">
                                ...
                                <span>Taxa de êxito Curioso: 
                                    @php
                                        $curiosoFees = isset($successFees['curioso']) ? $successFees['curioso'] : collect();
                                    @endphp
                                    @if($curiosoFees->count() > 0)
                                        @foreach($curiosoFees as $index => $fee)
                                            R$ {{ number_format($fee->fee_amount, 2, ',', '.') }} / {{ $fee->days }} dia{{ $fee->days > 1 ? 's' : '' }}@if(!$loop->last), @endif
                                        @endforeach
                                    @else
                                        Taxas não disponíveis
                                    @endif
                                    /aluguel. Troca por R$120,00 no meu hotel, e R$140,00 em outro hotel.
                                </span>
                            </div>
                    ...
                    <div class="profile-pricing">
                        ...
                        <a href="{{ route('register') }}" class="btn btn-outline-info btn-lg">
                            <i class="fas fa-arrow-right me-2"></i>Começar
                        </a>
                        <button type="button" class="btn btn-outline-secondary btn-sm mt-2" data-bs-toggle="modal" data-bs-target="#curiosoVideoModal">
                            <i class="fas fa-play me-2"></i>Assista à explicação
                        </button>
                    </div>
                </div>
            </div>
            ...
            <!-- Inteligente Card -->
            <div class="profile-card-horizontal popular" data-aos="fade-up" data-aos-delay="200">
                ...
                <div class="profile-card-content">
                        ...
                        <div class="profile-features">
                            ...
                            <div class="feature-item">
                                ...
                                <span>Taxas de êxito Inteligente: 
                                    @php
                                        $inteligenteFees = isset($successFees['inteligente']) ? $successFees['inteligente'] : collect();
                                    @endphp
                                    @if($inteligenteFees->count() > 0)
                                        @foreach($inteligenteFees as $index => $fee)
                                            R$ {{ number_format($fee->fee_amount, 2, ',', '.') }} / {{ $fee->days }} dia{{ $fee->days > 1 ? 's' : '' }}@if(!$loop->last), @endif
                                        @endforeach
                                    @else
                                        Taxas não disponíveis
                                    @endif
                                    para Aluguel, Troca R$125(em qualquer hotel)
                                </span>
                            </div>
                        </div>
                    </div>
                    <div class="profile-pricing">
                        ...
                        <button type="button" class="btn btn-outline-secondary btn-sm mt-2" data-bs-toggle="modal" data-bs-target="#inteligenteVideoModal">
                            <i class="fas fa-play me-2"></i>Assista à explicação
                        </button>
                    </div>
                </div>
            ...
            <!-- Sábio Card -->
            <div class="profile-card-horizontal" data-aos="fade-up" data-aos-delay="300">
                <div class="popular-badge" style="background-color:rgb(7, 114, 255); color: #FFF;">
                ...
                <div class="profile-card-content">
                        ...
                        <div class="profile-features">
                            ...
                            <div class="feature-item">
                                ...
                                <span>Taxas de êxito Sábio: 
                                    @php
                                        $sabioFees = isset($successFees['sabio']) ? $successFees['sabio'] : collect();
                                    @endphp
                                    @if($sabioFees->count() > 0)
                                        @foreach($sabioFees as $index => $fee)
                                            R$ {{ number_format($fee->fee_amount, 2, ',', '.') }} / {{ $fee->days }} dia{{ $fee->days > 1 ? 's' : '' }}@if(!$loop->last), @endif
                                        @endforeach
                                    @else
                                        Taxas não disponíveis
                                    @endif
                                    para Aluguel, Troca R$100 no meu hotel e R$150 em qualquer outro hotel.
                                </span>
                            </div>
                        </div>
                    </div>
                    <div class="profile-pricing">
                        <!--<div class="price">
                            <span class="price-amount">R$ 49</span>
                            <span class="price-period">/mês</span>
                        </div>-->
                        <a href="{{ route('register') }}" class="btn btn-warning btn-lg">
                            <i class="fas fa-arrow-right me-2"></i>Começar
                        </a>
                        <button type="button" class="btn btn-outline-secondary btn-sm mt-2" data-bs-toggle="modal" data-bs-target="#sabioVideoModal">
                            <i class="fas fa-play me-2"></i>Assista à explicação
                        </button>
                    </div>
                </div>
...
<!-- Video Modals -->
<!-- Curioso Video Modal -->
<div class="modal fade" id="curiosoVideoModal" tabindex="-1" aria-labelledby="curiosoVideoModalLabel" aria-hidden="true" data-bs-backdrop="true" data-bs-keyboard="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="curiosoVideoModalLabel">
                    <i class="fas fa-eye me-2 text-info"></i>Perfil Curioso - Explicação
                </h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <div class="video-container">
                    <video id="curiosoVideo" width="100%" height="auto" controls>
                        <source src="{{ asset('videos/curioso-explicacao.mp4') }}" type="video/mp4">
                        <source src="{{ asset('videos/curioso-explicacao.webm') }}" type="video/webm">
            ...
            <div class="modal-footer">
                ...
                <a href="{{ route('register') }}" class="btn btn-info">
                    <i class="fas fa-arrow-right me-2"></i>Começar como Curioso
                </a>
            </div>
        </div>
    </div>
...
<!-- Inteligente Video Modal -->
<div class="modal fade" id="inteligenteVideoModal" tabindex="-1" aria-labelledby="inteligenteVideoModalLabel" aria-hidden="true" data-bs-backdrop="true" data-bs-keyboard="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="inteligenteVideoModalLabel">
                    <i class="fas fa-brain me-2 text-primary"></i>Perfil Inteligente - Explicação
                </h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <div class="video-container">
                    <video id="inteligenteVideo" width="100%" height="auto" controls>
                        <source src="{{ asset('videos/inteligente-explicacao.mp4') }}" type="video/mp4">
                        <source src="{{ asset('videos/inteligente-explicacao.webm') }}" type="video/webm">
                        Seu navegador não suporta o elemento de vídeo.
                    </video>
                </div>
            </div>
            <div class="modal-footer">
                ...
                <a href="{{ route('register') }}" class="btn btn-primary">
                    <i class="fas fa-arrow-right me-2"></i>Começar como Inteligente
                </a>
            </div>
        </div>
    </div>
...
<!-- Sábio Video Modal -->
<div class="modal fade" id="sabioVideoModal" tabindex="-1" aria-labelledby="sabioVideoModalLabel" aria-hidden="true" data-bs-backdrop="true" data-bs-keyboard="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="sabioVideoModalLabel">
                    <i class="fas fa-crown me-2 text-warning"></i>Perfil Sábio - Explicação
                </h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <div class="video-container">
                    <video id="sabioVideo" width="100%" height="auto" controls>
                        <source src="{{ asset('videos/sabio-explicacao.mp4') }}" type="video/mp4">
                        <source src="{{ asset('videos/sabio-explicacao.webm') }}" type="video/webm">
                        Seu navegador não suporta o elemento de vídeo.
                    </video>
                </div>
            </div>
            <div class="modal-footer">
                ...
                <a href="{{ route('register') }}" class="btn btn-warning">
                    <i class="fas fa-arrow-right me-2"></i>Começar como Sábio
                </a>
            </div>
        </div>
    </div>
...
<section class="features py-5">
    <div class="container">
        <div class="row">
            <div class="col-12 text-center mb-5" data-aos="fade-up">
                <h2 class="display-5 fw-bold mb-3">Motivos para Escolher o Cota Brasilis</h2>
                <p class="lead text-muted">A plataforma profissional pioneira para Aluguel, Troca, Compra e Venda de Cotas de Multipropriedade Hoteleira</p>
            </div>
        </div>
        <div class="row g-4">
            <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
                <div class="feature-card text-center h-100">
                    ...
                    <p class="text-muted">Transações 100% seguras com contratos e assinaturas digitais,Termos de Autorização de Hospedagem oficiais,
                        gerando proteção completa para todos.
                    </p>
                </div>
            </div>
            <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
                <div class="feature-card text-center h-100">
                    ...
                    <h5 class="fw-bold mb-3">Funcionalidades Essenciais</h5>
                    <p class="text-muted">Recursos simples que resolvem suas necessidades para Alugar, Trocar, Comprar e Vender Cotas de Multipropriedade Hoteleira.</p>
                </div>
            </div>
            <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
                <div class="feature-card text-center h-100">
                    ...
                    <h5 class="fw-bold mb-3">Qualidade Superior</h5>
                    <p class="text-muted">Profissionais, Meios de Hospedagem e Tecnologias certificados e reconhecidos</p>
                </div>
            </div>
            <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
                <div class="feature-card text-center h-100">
                    ...
                    <p class="text-muted">Gerencie suas Cotas e  Frações de Hospedagens em suas Viagens Turísticas de qualquer lugar e facilmente com nosso aplicativo móvel completo.</p>
                </div>
            </div>
            <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
                <div class="feature-card text-center h-100">
                    ...
                    <h5 class="fw-bold mb-3">Processo Rápido</h5>
                    <p class="text-muted">Encontre Cotas e Frações, Alugue, Troque, Compre ou Venda(se quitada) em minutos com nosso sistema otimizado e intuitivo.</p>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="400">
                <div class="feature-card text-center h-100">
                    ...
                    <p class="text-muted">Nossa Equipe disponível para ajudá-lo a bem usufruir de suas Cotas de Multipropriedade Hoteleira.</p>
                </div>
            </div>
        </div>
    </div>
...
<section class="testimonials py-5 bg-light">
    <div class="container">
        <div class="row">
            <div class="col-12 text-center mb-5" data-aos="fade-up">
                <h2 class="display-5 fw-bold mb-3">Depoimentos de Sucesso</h2>
                <p class="lead text-muted">Histórias reais de proprietários e usuários de cotas hoteleiras</p>
            </div>
        </div>
        <div class="row g-4">
            <div class="col-lg-4" data-aos="fade-up" data-aos-delay="100">
                <div class="testimonial-card h-100">
                    <div class="testimonial-content">
                        ...
                        <p class="testimonial-text">"Consegui alugar minha cota em Fernando de Noronha com facilidade! A plataforma me conectou com o inquilino perfeito. Processo super seguro!"</p>
                    </div>
                    <div class="testimonial-author">
                        <div class="author-avatar">
                            <img src="https://images.unsplash.com/photo-1494790108755-2616b612b786?ixlib=rb-4.0.3&auto=format&fit=crop&w=150&q=80" alt="Maria Silva" class="rounded-circle">
                        </div>
                        <div class="author-info">
                            <div class="author-name fw-bold">Maria Silva</div>
                            <div class="author-role text-muted">Proprietária de Cota - São Paulo</div>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-lg-4" data-aos="fade-up" data-aos-delay="200">
                <div class="testimonial-card h-100">
                    <div class="testimonial-content">
                        ...
                        <p class="testimonial-text">"Excelente experiência alugando uma cota em Búzios! O processo foi super simples e o hotel era exatamente como mostrado. Recomendo muito!"</p>
                    </div>
                    <div class="testimonial-author">
                        <div class="author-avatar">
                            <img src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?ixlib=rb-4.0.3&auto=format&fit=crop&w=150&q=80" alt="João Santos" class="rounded-circle">
                        </div>
                        <div class="author-info">
                            <div class="author-name fw-bold">João Santos</div>
                            <div class="author-role text-muted">Usuário de Cota - Rio de Janeiro</div>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-lg-4" data-aos="fade-up" data-aos-delay="300">
                <div class="testimonial-card h-100">
                    <div class="testimonial-content">
                        ...
                        <p class="testimonial-text">"A melhor plataforma para proprietários de cotas! Consegui alugar e trocar minhas cotas com total segurança e facilidade."</p>
                    </div>
                    <div class="testimonial-author">
                        <div class="author-avatar">
                            <img src="https://images.unsplash.com/photo-1438761681033-6461ffad8d80?ixlib=rb-4.0.3&auto=format&fit=crop&w=150&q=80" alt="Ana Costa" class="rounded-circle">
                        </div>
                        <div class="author-info">
                            <div class="author-name fw-bold">Ana Costa</div>
                            <div class="author-role text-muted">Proprietária de Múltiplas Cotas - Belo Horizonte</div>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-8 text-center" data-aos="fade-up">
                <div class="cta-gradient-content">
                    <h2 class="display-5 fw-bold mb-3 text-white">Transforme suas Cotas em Sonhos Realizados</h2>
                    <p class="lead mb-4 text-white">
                        Faça parte dessa Viagem de Multiproprietários e Interessados pelo Turismo organizado, acessível e saudável para as pessoas e a natureza.
                    </p>
                    <div class="cta-gradient-buttons">
                        <a href="{{ route('register') }}" class="btn btn-warning btn-lg px-5 py-3 me-3 mb-3">
                            <i class="fas fa-building me-2"></i>Cadastre-se e comece a jornada
                        </a>
                        <!-- <a href="{{ route('login') }}" class="btn btn-outline-light btn-lg px-5 py-3 mb-3">
                            <i class="fas fa-sign-in-alt me-2"></i>Já sou Cadastrado
                        </a>-->
                    </div>
                </div>
            </div>
...
<style>
    ...
    .hero-highlight {
        font-weight: 700;
        background: linear-gradient(90deg, #5cd65c 0%, #f5c518 45%, #5cd65c 100%);
    ...
    .hero-col-stats .trust-indicators,
    .hero-col-stats .hero-actions {
        width: 100%;
        max-width: 420px;
    }
    ...
    @media (min-width: 992px) {
        ...
        .hero-split.row > .hero-col-stats,
        .hero-split.row > .hero-col-map {
            flex: none !important;
            width: 100% !important;
    ...
    section.hero-section #map {
        ...
        width: 100% !important;
        max-width: var(--hero-map-w) !important;
    ...
    @media (min-width: 992px) {
        ...
        .hero-map-inner {
            width: 100%;
            max-width: min(var(--hero-map-w), 100%);
        }

        .hero-section .hero-map-frame #map,
        section.hero-section #map {
            width: 100% !important;
            max-width: min(var(--hero-map-w), 100%) !important;
    ...
    .hero-section .col-lg-5:last-child > div {
        height: auto;
        min-height: auto;
    }
    ...
    /* Removed destination stats - now showing only hotel images */
    ...
    .cta-gradient-section {
        background: linear-gradient(135deg, #1e3c72 0%, #2a5298 25%, #28a745 50%, #20c997 75%, #ffc107 100%);
        position: relative;
        width: 100vw;
        margin-left: calc(-50vw + 50%);
        padding: 5rem 0;
    ...
    .cta-gradient-buttons .btn:hover {
        transform: translateY(-3px);
        box-shadow: 0 8px 25px rgba(0, 0, 0, 0.3);
    }

    .cta-gradient-buttons .btn-warning {
        background: linear-gradient(135deg, #ffc107 0%, #ff8c00 100%);
        border: none;
        color: #000;
    }

    .cta-gradient-buttons .btn-outline-light {
    ...
    .cta-gradient-buttons .btn-outline-light:hover {
        background: rgba(255, 255, 255, 0.2);
        border-color: white;
        color: white;
    }
    ...
    .profile-cards-horizontal-container {
        display: flex;
        flex-direction: column;
        gap: 2rem;
        max-width: 100%;
    ...
    .profile-card-horizontal[data-aos-delay="100"] .profile-icon {
        background: linear-gradient(135deg, #17a2b8 0%, #20c997 100%);
    }

    .profile-card-horizontal[data-aos-delay="200"] .profile-icon {
        background: linear-gradient(135deg, #007bff 0%, #6610f2 100%);
    }

    .profile-card-horizontal[data-aos-delay="300"] .profile-icon {
    ...
    @media (max-width: 768px) {
        ...
        /* Ajustes para seções de largura total */
        .destinations-section,
        .cta-gradient-section,
        .stats-section,
        .how-it-works,
    ...
    @media (max-width: 576px) {
        ...
        .hero-title {
            font-size: clamp(1.4rem, 6vw + 0.4rem, 2rem);
            line-height: 1.35;
        }
    ...
    @media (max-width: 400px) {
        .hero-title {
            font-size: clamp(1.3rem, 6.5vw + 0.3rem, 1.85rem);
        }
    ...
    /* Video Modal Styles - ULTRA HIGH Z-INDEX */
    .modal {
    ...
    /* Force ALL modals to be on top - ULTRA HIGH */
    .modal.show {
        z-index: 2147483647 !important;
    }
...
<script>
    // Video Modal Controls - ULTRA FORCE MODAL TO FRONT
    document.addEventListener('DOMContentLoaded', function() {
        // Map Brazil states functionality
        const statesWithQuotas = <?php echo json_encode($statesWithQuotas ?? []); ?>;

        // Apply classes to states based on quotas availability
        statesWithQuotas.forEach(stateCode => {
            const stateElement = document.getElementById('state_' + stateCode);
            const shapeElement = document.getElementById('shape_' + stateCode);

            if (stateElement && shapeElement) {
                shapeElement.classList.add('has-quotas');

                // Add click handler to redirect to public quotas search
                stateElement.addEventListener('click', function(e) {
                    e.preventDefault();
                    const stateUpper = stateCode.toUpperCase();
                    window.location.href = "{{ route('public.quotas.index') }}?state=" + stateUpper;
                });
            }
        });

        // Mark states without quotas
        ...
        allStates.forEach(stateCode => {
            if (!statesWithQuotas.includes(stateCode)) {
                const shapeElement = document.getElementById('shape_' + stateCode);
                if (shapeElement) {
                    shapeElement.classList.add('no-quotas');
                }
            }
        });

        const MAX_Z_INDEX = '2147483647'; // Maximum possible z-index value

        // Function to force modal to front with MAXIMUM z-index
        function forceModalToFront(modal) {
            if (modal) {
                // Force modal itself
                modal.style.zIndex = MAX_Z_INDEX;
                modal.style.position = 'fixed';

                // Force all child elements
                const allElements = modal.querySelectorAll('*');
                allElements.forEach(element => {
                    element.style.zIndex = MAX_Z_INDEX;
                });
                ...
                if (content) {
                    content.style.zIndex = MAX_Z_INDEX;
                    content.style.position = 'relative';
                    content.style.background = 'white';
                }
                if (header) {
                    header.style.zIndex = MAX_Z_INDEX;
                    header.style.position = 'relative';
                }
                if (body) {
                    body.style.zIndex = MAX_Z_INDEX;
                    body.style.position = 'relative';
                    body.style.background = 'white';
                }
                if (footer) {
                    footer.style.zIndex = MAX_Z_INDEX;
                    footer.style.position = 'relative';
                }
            }
        }

        // Function to force backdrop behind modal
        ...
        // Function to override ALL z-index values on page
        function overrideAllZIndex() {
        ...
        // Curioso Video Modal
        const curiosoModal = document.getElementById('curiosoVideoModal');
        const curiosoVideo = document.getElementById('curiosoVideo');

        if (curiosoModal && curiosoVideo) {
            curiosoModal.addEventListener('show.bs.modal', function() {
                overrideAllZIndex();
                forceModalToFront(curiosoModal);
                setTimeout(fixBackdrop, 10);
            });

            curiosoModal.addEventListener('shown.bs.modal', function() {
                overrideAllZIndex();
                forceModalToFront(curiosoModal);
                fixBackdrop();
                curiosoVideo.play();
            ...
            curiosoModal.addEventListener('hidden.bs.modal', function() {
                curiosoVideo.pause();
                curiosoVideo.currentTime = 0;
            });
        }

        // Inteligente Video Modal
        const inteligenteModal = document.getElementById('inteligenteVideoModal');
        const inteligenteVideo = document.getElementById('inteligenteVideo');

        if (inteligenteModal && inteligenteVideo) {
            inteligenteModal.addEventListener('show.bs.modal', function() {
                overrideAllZIndex();
                forceModalToFront(inteligenteModal);
                setTimeout(fixBackdrop, 10);
            });

            inteligenteModal.addEventListener('shown.bs.modal', function() {
                overrideAllZIndex();
                forceModalToFront(inteligenteModal);
                fixBackdrop();
                inteligenteVideo.play();
            });

            inteligenteModal.addEventListener('hidden.bs.modal', function() {
                inteligenteVideo.pause();
                inteligenteVideo.currentTime = 0;
            });
        }

        // Sábio Video Modal
        const sabioModal = document.getElementById('sabioVideoModal');
        const sabioVideo = document.getElementById('sabioVideo');

        if (sabioModal && sabioVideo) {
            sabioModal.addEventListener('show.bs.modal', function() {
                overrideAllZIndex();
                forceModalToFront(sabioModal);
                setTimeout(fixBackdrop, 10);
            });

            sabioModal.addEventListener('shown.bs.modal', function() {
                overrideAllZIndex();
                forceModalToFront(sabioModal);
                fixBackdrop();
                sabioVideo.play();
            ...
            sabioModal.addEventListener('hidden.bs.modal', function() {
                sabioVideo.pause();
                sabioVideo.currentTime = 0;
            });
        }

        // Global fix for all modals
        document.addEventListener('shown.bs.modal', function(e) {
            overrideAllZIndex();
            forceModalToFront(e.target);
            fixBackdrop();
        });

        // Continuous monitoring to ensure modal stays on top
        setInterval(function() {
            const openModals = document.querySelectorAll('.modal.show');
            openModals.forEach(modal => {
                forceModalToFront(modal);
                fixBackdrop();
            });
        }, 100);
    });
