...
@section('title', 'Taxa de êxito — Troca')
        ...
        <div class="col-lg-8">
            ...
            <div class="card shadow-lg border-0 rounded-4 mb-4">
                <div class="card-header bg-success text-white py-4 rounded-top-4">
                    <h3 class="mb-0">
                        <i class="fas fa-credit-card me-2"></i>Taxa de êxito (troca justa)
                    </h3>
                </div>
                <div class="card-body p-4">
                    ...
                    <div class="alert alert-info mb-4">
                        ...
                        Esta troca não envolve pagamento de valores entre cotistas — apenas a <strong>taxa de êxito</strong> da plataforma (troca justa).
                    </div>
                    @if(($transaction->platform_fee ?? 0) > 0)
                    <div class="mb-4">
                        <h5 class="fw-bold mb-3">Taxa de êxito</h5>
                        <div class="d-flex justify-content-between">
                            <span class="fs-5 fw-bold">Total a pagar:</span>
                            <span class="fs-4 fw-bold text-success">R$ {{ number_format($transaction->platform_fee, 2, ',', '.') }}</span>
                        </div>
                    </div>
                    @endif
