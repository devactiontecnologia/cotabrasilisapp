        ...
        <div class="card border-0 shadow-sm h-100 bg-white">
            <div class="card-body p-4">
                ...
                <p class="mb-4 text-muted">
                    Busque e solicite compra de cotas disponíveis que atendam às suas necessidades.
                </p>
                <a href="{{ route('purchases.refine') }}" class="btn btn-success btn-lg fw-bold">
                    <i class="fas fa-shopping-cart me-2"></i>Comprar Cota(s)
                </a>
            </div>
        </div>
    </div>
        ...
        @if($purchases->isEmpty())
            <div class="text-center py-5">
                ...
                <p class="text-muted mb-4" style="max-width: 520px; margin: 0 auto;">
                    Crie uma solicitação de compra para encontrar cotas que atendam às suas necessidades.
                </p>
                <a href="{{ route('purchases.create') }}" class="btn btn-success btn-lg px-4">
