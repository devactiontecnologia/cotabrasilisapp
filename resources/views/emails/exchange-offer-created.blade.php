...
<head>
    ...
    <title>Anúncio de Troca Criado - Cota Brasilis</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="email-container">
        ...
        <div class="email-body">
            ...
            <p>
                Seu anúncio de <strong>troca</strong> foi criado com sucesso na plataforma <strong>Cota Brasilis</strong>!
            </p>
            ...
            <p>
                Seu anúncio já está visível para outros usuários da plataforma que buscam fazer trocas. Você pode gerenciá-lo a qualquer momento através do seu painel.
            </p>

            <div class="button-container">
                <a href="{{ route('exchanges.index') }}" class="action-button">
                    Ver Meus Anúncios de Troca
                </a>
            </div>

            <p style="margin-top: 30px; color: #999; font-size: 14px;">
                Boa sorte com sua troca! 🎉
            </p>
        </div>
