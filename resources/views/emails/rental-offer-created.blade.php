...
<head>
    ...
    <title>Anúncio de Aluguel Criado - Cota Brasilis</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="email-container">
        ...
        <div class="email-header">
            ...
            <h1>Anúncio de Aluguel Criado!</h1>
        ...
        <div class="email-body">
            ...
            <p>
                Seu anúncio de <strong>aluguel</strong> foi criado com sucesso na plataforma <strong>Cota Brasilis</strong>!
            </p>
            ...
            <p>
                Seu anúncio já está visível para outros usuários da plataforma. Você pode gerenciá-lo a qualquer momento através do seu painel.
            </p>

            <div class="button-container">
                <a href="{{ route('rental-offers.my') }}" class="action-button">
                    Ver Meus Anúncios
                </a>
            </div>

            <p style="margin-top: 30px; color: #999; font-size: 14px;">
                Boa sorte com seu anúncio! 🎉
            </p>
        </div>
